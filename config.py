...
class Config(object):
    ...
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://indok666:tV8UJnxJ3HgWu9jf@cluster0.ffu2siq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
